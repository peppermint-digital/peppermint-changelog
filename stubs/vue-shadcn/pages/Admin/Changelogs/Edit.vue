...
const breadcrumbItems: BreadcrumbItem[] = [
    ...
    { title: 'Bearbeiten', href: `/admin/changelogs/${props.changelog.slug}/edit` },
];

const form = useForm({
    version: props.changelog.version ?? '',
    title: props.changelog.title,
    content: props.changelog.content,
    published_at: props.changelog.published_at ?? '',
    show_modal: props.changelog.show_modal,
    is_active: props.changelog.is_active,
});

function submit() {
    form.put(`/admin/changelogs/${props.changelog.slug}`);
}
</script>
    ...
    <AppLayout :breadcrumbs="breadcrumbItems">
        ...
        <div class="space-y-6 p-6">
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-3xl font-bold">Changelog bearbeiten</h1>
                                ...
                                <div class="grid gap-4 sm:grid-cols-2">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <Input
                                            ...
                                            class="bg-muted"
                                        />
                                        <p class="text-xs text-muted-foreground">Der Slug kann nicht geändert werden</p>
                                    </div>
                                </div>
